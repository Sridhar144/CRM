...
class RecordForm(forms.ModelForm):
    ...
    email=forms.EmailField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Mail","class":"form-control"}),label="")
    phone=forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Contact","class":"form-control"}),label="")
